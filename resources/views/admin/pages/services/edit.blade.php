        ...
        <div class="row mb-5">
            ...
            <div class="card bg-card-dark rounded border-4 mb-2 p-1 text-white">
                ...
                <div class="col-12 mb-3">
                    ...
                    <textarea name="short_description" id="short_description" class="form-control">{{ $items['short_description'] ?? '' }}</textarea>
                    <small class="text-danger"><b>(Required)</b></small>
                </div>
                <div class="col-12 mb-3">
                    <label for="description">Description:</label>
                    <textarea name="description" id="description" class="form-control">{{ $items['description'] ?? '' }}</textarea>
                    <small class="text-danger"><b>(Required)</b></small>
                </div>
                <div class="col-12 mb-3">
                    <label for="icon">Icon:</label>
                    <select id="iconSelect" class="js-example-basic-single form-control" name="icon">
                        <option class="d-block" selected disabled>{{ $items['icon'] ?? 'Select an Icon' }}</option>
                    </select>
                    <small class="text-danger"><b>(Required)</b></small>
                </div>
            </div>
            ...
            <div class="col-6">
                ...
                <div class="col-12 mb-3">
                    ...
                    <input type="file" name="img"  id="avatarImg" class="form-control metControl" style="height: auto" value="{{ $items['img'] ?? '' }}" for="">
                    <small class="text-danger"><b>(Required)</b></small>
                    <input type="file" name="croppedImg" id="croppedImg" style="display: none;">
                </div>
                <div class="col">
                    <div class="mb-3 d-flex justify-content-center mt-1">
                        <img id="showImg" src="{{ (!empty($items['image']))? url('admin/slider/'.$items['image'] ):url('admin/avatars/empty.svg')}}" width="250" class="img-thumbnail rounded">
                    </div>
                </div>
                </div>
                </div>
