        ...
        <div class="row mb-5">
            ...
            <div class="col-6">
                ...
                <div class="col-12 mb-3">
                    ...
                    <input type="file" name="img0"  id="avatarImg0" class="form-control metControl" style="height: auto" value="{{ $items['image'] ?? '' }}" for="">
                    <small class="text-danger"><b>(Required)</b></small>
                ...
                <div class="card bg-card-dark rounded border-4 mb-2 p-1 text-white">
                    <div class="col-12 mb-3">
                        ...
                        <input type="file" name="img1"  id="avatarImg1" class="form-control metControl" style="height: auto" value="{{ $items['image_theme'] ?? '' }}" for="">
                        <small class="text-danger"><b>(Required)</b></small>
