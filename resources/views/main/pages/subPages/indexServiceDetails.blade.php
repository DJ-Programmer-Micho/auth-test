...
<div class="container-fluid bg-primary py-5 " style="margin-bottom: 90px; background: linear-gradient(rgba(9, 30, 62, .7), rgba(9, 30, 62, .7)), url({{url('https://d26ttzql3lait9.cloudfront.net/ttsiraq/services/'.$serviceDetail['image_theme'])}}) center center no-repeat;">
    <div class="row py-5">
        <div class="col-12 pt-lg-5 mt-lg-5 text-center">
            ...
            <a href="" class="h5 text-white">{{$serviceDetail['title']}}</a>
        </div>
    </div>
</div>
    <!-- Blog Start -->
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="link-animated d-flex flex-column justify-content-start">
                            @foreach ($serviceAll as $servicename)
                                @if ($servicename['id'] == $serviceDetail['id'])
                                    @continue
                                @endif
                                <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="{{route('service.details',$servicename['id'])}}"><i class="bi bi-arrow-right me-2"></i>{{$servicename['title']}}</a>
                            @endforeach
                        </div>
                    </div>
                    <!-- Category End -->
