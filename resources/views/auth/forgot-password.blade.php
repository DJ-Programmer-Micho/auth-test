...
<head>
    ...
    <title>MET IRAQ - Forgot Password</title>
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="{{ route('password.email') }}">
                                        ...
                                        <div class="form-group">
                                            <input id="email" class="form-control form-control-user" type="email" name="email" aria-describedby="emailHelp" placeholder="Enter Email Address...">
                                        </div>
